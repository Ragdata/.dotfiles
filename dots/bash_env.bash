...
####################################################################
declare -gxa SEARCH_CFG IMPORTS

declare -gx ALIASES APPS ASSETS COMPLETIONS CUSTOM FUNCTIONS PKGS
declare -gx PLUGINS PROMPTS SHELL TEMP TEMPLATES DOTFILES_VERSION DOTFILES_PROMPT

declare -gx DOTFILES DOT_BIN DOT_CFG DOTS DOT_ETC DOT_LIB DOT_REG DOT_LOG

declare -gx NODE_IPv4 NODE_HOSTNAME GIT_USER GIT_EMAIL GPG_EMAIL GPG_KEYID SIGN_COMMITS

declare -gx LOG_SYSLOG LOG_SIZE LOG_BACKUPS LOG_ARCHIVE LOG_FILE
