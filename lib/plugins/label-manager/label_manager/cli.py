...
def _parser() -> argparse.ArgumentParser:
    ...
    dump = sub.add_parser('dump', help='Dump repo labels to local file')
    dump.add_argument('-f', '--file', type=pathlib.Path, help='File path to dump labels to')

    update = sub.add_parser('update', help='Update repo labels using the specified label definition file')
    update.add_argument('-f', '--file', type=pathlib.Path, help='Path to file containing label definitions')
