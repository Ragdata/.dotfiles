...
declare -x ALIASES APPS ASSETS COMPLETIONS CUSTOM FUNCTIONS HELP PKGS SCRIPTS
declare -x PLUGINS PROMPTS SHELL TEMP TEMPLATES DOTFILES_VERSION DOTFILES_PROMPT

declare -x DOTFILES DOT_BIN DOT_CFG DOTS DOT_ETC DOT_INC DOT_LIB DOT_REG DOT_LOG TEMP
