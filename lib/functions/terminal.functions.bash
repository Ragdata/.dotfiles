...
# PREFLIGHT
####################################################################
[[ -z ${_TERM_FUNCTIONS+x} ]] && declare -gx _TERM_FUNCTIONS
[[ "$_TERM_FUNCTIONS" -eq 1 ]] && return 0; _TERM_FUNCTIONS=1;
####################################################################
# TERMINAL VARIABLES
####################################################################
declare -gx TERM_ESC TERM_CSI TERM_OSC TERM_ST BG_RESET BG_0
declare -gx RESET _0 BLACK RED GREEN GOLD BLUE MAGENTA CYAN LT_GREY
declare -gx GREY PINK LT_GREEN YELLOW LT_BLUE PURPLE LT_CYAN WHITE
declare -gx BG_BLACK BG_RED BG_GREEN BG_GOLD BG_BLUE BG_MAGENTA BG_CYAN BG_LT_GREY
declare -gx BG_GREY BG_PINK BG_LT_GREEN BG_YELLOW BG_LT_BLUE BG_PURPLE BG_LT_CYAN BG_WHITE
declare -gx BLINK BLINK_RAPID NO_BLINK BOLD ITALIC NORMAL DIM INVERSE NO_INVERSE
declare -gx OVERLINE NO_OVERLINE UNDERLINE DOUBLE_UNDERLINE NO_UNDERLINE
declare -gx UNDEROVER NO_UNDEROVER INVISIBLE VISIBLE PLAIN STRIKE NO_STRIKE
declare -gx SYMBOL_ERROR SYMBOL_WARNING SYMBOL_INFO SYMBOL_SUCCESS
declare -gx DEFAULT_Y DEFAULT_N
#
# ESCAPE CHARACTERS
#
TERM_ESC=$'\033'
